...
RUN wget https://releases.hashicorp.com/terraform/0.11.5/terraform_0.11.5_linux_amd64.zip >/dev/null 2>&1
RUN unzip terraform_0.11.5_linux_amd64.zip >/dev/null
